...
<head>
    ...
    @php
    $platformConfigs = \App\Models\ConfiguracaoSistema::pluck('valor', 'chave')->toArray();
@endphp

@if(!empty($platformConfigs['plataforma_favicon']))
    <link rel="icon" type="image/png" href="{{ asset('storage/' . $platformConfigs['plataforma_favicon']) }}">
@else
